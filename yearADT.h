...
** ------------------------------------------------------------------
** Descripción:     Recibe el set->provVec->years y crea un nodo
**                  nuevo si el año no existe. Si el año ya existe,
**                  actúa como bagADT y suma uno a su género
**                  correspondiente.
** ------------------------------------------------------------------
** Precondición:    Lista de años válida, previamente creada.
** Postcondición:   Lista years con un nuevo nodo.
*/
...
** ------------------------------------------------------------------
** Precondición:    Los datos de provincias y nacimientos deben estar
**                  cargados en la estructura.
** Postcondición:   --                    -
*/
...
** ------------------------------------------------------------------
** Descripción:     Retorna en su nombre si hay un siguiente
**                  nodo en la lista.
** ------------------------------------------------------------------
